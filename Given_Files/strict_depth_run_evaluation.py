#!/usr/bin/env python3
"""Command-line interface for model evaluation. Copied from run_evaluation.py
edited to use strict_depth_generator through strict_depth_evaluator"""

import argparse
from .strict_depth_evaluator import ModelEvaluator
